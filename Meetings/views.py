...
class NewMeetingView(View):
    ...
    def post(self,request):
        ...
        if filled_form.is_valid():
            ...
            send_mail('Data science traniee','please join this training program.Register ASAp',None,['nusimsubbareddy@gmail.com','kannamanikanta799@gmail.com','brahmaiahkanna8@gmail.com'],fail_silently=False)
